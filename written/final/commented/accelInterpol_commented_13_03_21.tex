...
\textbf{In Progress: Used in some examples}}
...
\dd{It is useful to wrap all the function symbols in Latex macros \\ \textbf{In Progress}}
\ts{And to use mathit for identifiers consisting of several letters (like $\mathit{Var}$) \\
\textbf{In Progress: Var, Loc, Stmt, init, err, post are now in mathit}}
...
\dd{Alternative display of trace: \\ \textbf{Review Pending: Found alternative display using tables}}
