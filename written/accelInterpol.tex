...
\begin{figure}[H]
	...
	\begin{tikzpicture}[%
		...
		\node[state] (5) [right= of 4] {$\loc{6}$};
		\node[state] (6) [below= of 1] {$\loc{2}$};
		\node[state] (7) [right= of 6] {$\loc{3}$};
		\node[state] (8) [right= of 7] {$\loc{5}$};
		\node[state] (9) [right= of 8] {$\loc{6}$};
		\node[state] (10) [right= of 9] {$\loc{2}$};
		\node[state] (11) [below= of 6] {$\loc{3}$};
		\node[state] (12) [right= of 11] {$\loc{4}$};
		\node[state] (13) [right= of 12] {$\loc{6}$};
		\node[state] (14) [right= of 13] {$\loc{2}$};
		\node[state] (15) [right= of 14] {$\loc{3}$};
		\node[state] (16) [below= of 11] {$\loc{4}$};
		\node[state] (17) [right= of 16] {$\loc{6}$};
		\node[state] (18) [right= of 17] {$\loc{2}$};
		\node[state] (19) [right= of 18] {$\loc{7}$};
		\node[state] (20) [right= of 19] {$\loc{9}$};
