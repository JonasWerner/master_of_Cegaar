...
\begin{mydef}
		Given a program $P = (Loc, \delta, \ell_{init}, \ell_{err})$ and a program trace $\tau: s_0, s_1, \ldots, s_n$. If $(\ell_0, s_i, \ell_1) \in \delta\ $ and $(\ell_{n-1}, s_n, \ell_0) \in \delta $. $\ell_0$ then $\tau$ is a loop trace. $\ell_0$ is called the loop head.
\end{mydef}
