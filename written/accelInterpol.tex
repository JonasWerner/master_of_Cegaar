...
\begin{figure}[H]
	\begin{center}
		\begin{tabular}{ccc}
			...
			\accel{1}                      &                                           &         \\
			                               & \makecell{\itp{102 < y \lor 2x + 1 \leq y
			\land  y \leq 103 \lor x = 0}} & \loc{3'}                                            \\
			\st{x>50}                      &                                           &         \\
			                               & \itp{y = 103}                             & \loc{6} \\
			\st{y!=103}                    &                                           &         \\
			                               & \itp{\bot}                                & \loc{7} \\
	...
	\begin{center}
		\begin{tabular}{ccc}
			...
			\st{y:=y+2} &                                                              &         \\
			            & \itp{y = 2x + 1 \land x \leq 51}                             & \loc{3} \\
			\st{x>50}   &                                                              &         \\
			            & \itp{y = 2x + 1 \land x \leq 51 \land x > 50 \equiv y = 103} & \loc{6} \\
			\st{y!=103} &                                                              &         \\
			            & \itp{\bot}                                                   & \loc{7}
		\end{tabular}
	\end{center}
...
\begin{figure}[H]
	...
	\begin{tikzpicture}[%
			...
			node distance=2.5cm, scale=1,
			transform shape, align=center,
			smallnode/.style={inner sep=1.4}, initial text =,
			anchor=center]
