...
\begin{figure}[H]
	...
	\label{fig:rect}
\end{figure}
And assume further that trace abstraction generated the following error trace:
...
\jw{Todo: explanation on why branching loops are bad: We cannot get a finite number of minimal loop traces, as the interweaving of the loop paths create infinitely many.}
